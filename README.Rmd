...
![Navigation to PAT generation, pt 1](img1):

Find the developer settings tab:
![Navigation to PAT generation, pt 2](img2):

And choose the token options that are appropriate for you:
![Navigation to PAT generation, pt 3](img3):
...
![login and script launch part 1](img4):

And I can check that that process is running successfully:
![login and script launch part 2](img5):
...
![login and script launch part 3](img6):
